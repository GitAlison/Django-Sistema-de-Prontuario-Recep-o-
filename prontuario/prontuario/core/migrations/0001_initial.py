# Generated by Django 2.2 on 2018-10-13 10:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logradouro', models.CharField(blank=True, max_length=90, null=True, verbose_name='Logradouro')),
                ...
                ('uf', models.CharField(blank=True, max_length=6, null=True, verbose_name='UF')),
                ('complemento', models.TextField(blank=True, null=True, verbose_name='Complemento')),
                ('status', models.CharField(blank=True, choices=[('Desativado', 'DESATIVADO'), ('Ativado', 'ATIVADO')], default='Ativado', max_length=11, verbose_name='Status')),
